        ...
        cred = credentials.Certificate(r"C:\Users\salut\OneDrive\Documentos\Sevent\Connecion firebase\aurora-dev-firebase.json")

        # Inicialize o Firebase
        firebase_admin.initialize_app(cred, {
            'storageBucket': 'sevent-aurora-dev.firebasestorage.app'
        })
